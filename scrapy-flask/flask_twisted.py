...
from science import PaperSpider
...
def crawl_for_quotes():
    ...
    if not scrape_in_progress:
        ...
        eventual = crawl_runner.crawl(PaperSpider, quotes_list=quotes_list)
        eventual.addCallback(finished_scrape)
        return 'SCRAPING %d' % len(quotes_list)
